...
public class CustomFlipTransition: NSObject,UIViewControllerAnimatedTransitioning {
    ...
    public func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        if self.transitionMode == .Present {
            ...
            UIView.transitionWithView(self.cardView, duration: 0.35 /*0.7*/, options: [.TransitionFlipFromLeft,.CurveEaseOut], animations: {
            ...
            UIView.transitionWithView(fromView!, duration: 0.35 /*0.7*/, options: [.TransitionFlipFromRight,.CurveEaseOut], animations: {
