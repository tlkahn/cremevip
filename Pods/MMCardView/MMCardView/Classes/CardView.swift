...
public class CardView: UIView {
    ...
    private func setUp() {
        ...
        let right = NSLayoutConstraint.init(item: collectionView, attribute: .Right, relatedBy: .Equal, toItem: collectionView.superview!, attribute: .Right, multiplier: 1.0, constant: -15.0)
